...
const APP_HEADER __Vectors __attribute__((section("HEADER"))) __attribute__((used)) = {
	...
	sizeof(APP_HEADER) + 0x00000118, // SVC_Handler
	sizeof(APP_HEADER) + 0x00000008, // DebugMon_Handler
	sizeof(APP_HEADER) + 0x00000078, // PendSV_Handler
	sizeof(APP_HEADER) + 0x00000120, // SysTick_Handler
	sizeof(APP_HEADER) + 0x00000168, // WWDG_Handler
	sizeof(APP_HEADER) + 0x00000080, // PVD_Handler
	sizeof(APP_HEADER) + 0x00000100, // RTC_Handler
	...
	sizeof(APP_HEADER) + 0x00000148, // TSC
	...
	sizeof(APP_HEADER) + 0x00000138, // TMI2_Handler
	sizeof(APP_HEADER) + 0x00000140, // TIM6_DAC
	sizeof(APP_HEADER) + 0x00000128, // TIM21
	sizeof(APP_HEADER) + 0x00000130, // TIM22
	sizeof(APP_HEADER) + 0x00000050, // I2C1
	sizeof(APP_HEADER) + 0x00000058, // I2C2
	sizeof(APP_HEADER) + 0x00000108, // SPI1
	sizeof(APP_HEADER) + 0x00000110, // SPI2
	sizeof(APP_HEADER) + 0x00000150, // USART1
	sizeof(APP_HEADER) + 0x00000158, // USART2
	sizeof(APP_HEADER) + 0x00000098, // RNG_LPUART1
	sizeof(APP_HEADER) + 0x00000060, // LCD
	sizeof(APP_HEADER) + 0x00000160  // USB
};